...
public class PingYinUtil {
	 ...
	 * @return
	 */
	public static String getFirstLetter(String strChinese, boolean bUpCase) {
		String letter = getPYIndexStr(strChinese, true);
	...
	public static void main(String[] args) {
		...
		System.out.println("中文首字母：" + getFirstLetter(str, true));
